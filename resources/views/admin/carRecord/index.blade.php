...
<head>
    ...
    <meta name="description" content="三晖科技考勤打卡系统">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    {{--</a>--}}
                    <form method="get" action="{{ route('carRecord.search') }}">
                        <div class="form-group form-inline row text-left" id="data_5">
                            ...
                            <div class="input-daterange input-group" id="datepicker">
                                ...
                                <input type="text" name="license" class="input-sm form-control" placeholder="车牌号码" value="{{ isset($filter['license']) ? $filter['license'] : '' }}">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        @foreach($carNumbers as $carNumber)
                            <tr class="gradeC">
                                <td>{{ $carNumber->id }}</td>
                                <td>{{ $carNumber->license }}</td>
                                <td>{{ $carNumber->created_at }}</td>
                                <td class="center">
                                    ...
                                    <button class="btn btn-warning btn-xs delete" data-id="{{ $carNumber->id }}">删除</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                    ...
                    {{ $carNumbers->appends($filter)->links() }}
                </div>
            </div>
        </div>
    </div>
