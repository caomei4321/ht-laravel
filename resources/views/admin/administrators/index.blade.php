        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <a href="{{ route('admin.administrators.create') }}"><button class="btn btn-info " type="button"><i class="fa fa-paste"></i> 添加管理员</button>
                    </a>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        @foreach($administrators as $administrator)
                            <tr class="gradeC">
                                ...
                                <td>{{ $administrator->company['company_name'] }}</td>
                                <td class="center">{{ $administrator->created_at }}</td>
                                <td class="center">
                                    <a href="{{ route('admin.administrators.edit',['administrator' => $administrator->id]) }}"><button type="button" class="btn btn-primary btn-xs">编辑</button></a>
                                    <a href="{{ route('admin.administrators.show',['administrator' => $administrator->id]) }}"><button type="button" class="btn btn-danger btn-xs">查看</button></a>
                                    <button class="btn btn-warning btn-xs delete" data-id="{{ $administrator->id }}">删除</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
