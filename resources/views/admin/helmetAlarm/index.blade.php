            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tbody>
                        @foreach($helmetAlarms as $helmetAlarm)
                            <tr class="gradeC">
                                <td>{{ $helmetAlarm->device_id }}</td>
                                <td>{{ $helmetAlarm->sum }}</td>
                                <td>{{ $helmetAlarm->alarm_time }}</td>
                                <td>{{ $helmetAlarm->alarm_pic_url }}</td>
                                <td class="center">
                                    ...
                                    <button class="btn btn-warning btn-xs delete" data-id="{{ $helmetAlarm->id }}">删除</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
