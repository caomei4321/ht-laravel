...
<head>
    ...
    <script src="{{ asset('assets/admin/javascript/plug-ins/echarts.min.js') }}"></script>
    <script src="{{ asset('assets/admin/javascript/plug-ins/layerUi/layer.js') }}"></script>
    <script src="{{ asset('assets/admin/editor/ueditor.config.js') }}"></script>
    <script src="{{ asset('assets/admin/editor/ueditor.all.js') }}" ></script>
    <script src="{{ asset('assets/admin/javascript/plug-ins/pagination.js') }}"></script>
    ...
    <div class="content-wrap">
        <header class="top-hd">
            ...
            <div class="hd-rt">
                <ul>
                    <li>
                        <a href="http://www.deathghost.cn" target="_blank"><i class="icon-home"></i>前台访问</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="javascript:void(0)" id="JsSignOut" onclick="document.getElementById('logout').submit()"><i class="icon-signout"></i>安全退出</a>
                    </li>
        ...
        <footer class="btm-ft">
            <p class="clear">
                <span class="fl">©Copyright 2016 <a href="http://www.deathghost.cn" title="DeathGhost" target="_blank">DeathGhost.cn</a></span>
